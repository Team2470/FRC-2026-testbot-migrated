...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.y().whileTrue(Commands.runOnce(() -> shooter.increaseDistance()));
        joystick.x().whileTrue(Commands.runOnce(() -> shooter.decreaseDistance()));
        ...
        joystick.rightBumper().whileTrue(shooter.changeShootingTarget());
